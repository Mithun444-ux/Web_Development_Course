...
[![GitHub repo size](https://img.shields.io/github/repo-size/Mithun444-ux/Web_Development_Course?color=blue&style=for-the-badge)](https://github.com/Mithun444-ux/Web_Development_Course)
...
[![Author](https://img.shields.io/badge/Author-Mithun%20R%20K-brightgreen?style=for-the-badge&logo=github)](https://github.com/Mithun444-ux)
...
| **08** | **Age Calculator** | Exact date & age computation across years, months, and days from user input date |
...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/Mithun444-ux/Web_Development_Course.git
   ```

2. **Navigate into the project directory:**
   ```bash
   cd Web_Development_Course
   ```
